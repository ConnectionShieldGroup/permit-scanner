...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      'hover:border-gold-400/50 hover:-translate-y-0.5 hover:shadow-card-hover',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex items-center gap-2 p-5 pt-3 border-t border-border/50', className)}
    {...props}
  />
));
